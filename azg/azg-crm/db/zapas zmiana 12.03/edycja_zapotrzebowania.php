...
<?php
    ...
    {
        if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['zapotrzebowanie_id']))
        {
            ...
            if (isset($_POST['zatwierdz']))
            {
                ...
                if (isset($wynik[0]))
                {
                    if ($wynik[0] != null)
                    {
                        ...
                        //w celu zapobiegniecia pamietaniu nieaktuqalnej inforamcji czyscimy sesje z ta infoamcja
                        //w tym przypadku id klient nie bedzie juz potrzebne, a za to moze zaszkodzic
            ...
            if (isset($_POST['edycja']))
            {
                ...
                if($iloscWierszy == 1)
                {
                    ...
                    echo $tlumaczenia->Tlumacz($_SESSION[$jezyk], tags::$numer_zapotrzebowania).' :'.$_POST['zapotrzebowanie_id'].'.<br/>';
                    $_SESSION[NieruchomoscDAL::$id_zapotrzebowanie] = $_POST['zapotrzebowanie_id'];
                    ...
                    NieruchomoscDAL::$id_zapotrzebowanie.'='.$_SESSION[NieruchomoscDAL::$id_zapotrzebowanie], 1000, 700);
                    echo '</td></tr></table>';   
                    ...
                    foreach ($tabNieruchomosc as $wierszNier)
                    {
                        ...
                        echo '<td>';
                        KontrolkiHtml::DodajCheckbox('nieruchomosc'.$wierszNier['id'], $wierszNier['id'], $checked, $wierszNier['nazwa'], $readonly);
                        echo '</td>';
                    }
