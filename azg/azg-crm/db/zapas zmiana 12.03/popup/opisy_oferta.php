...
<?php
    ...
    else
    {
        ...
        $wynik = $dal->PodajDostOpisOferta(array(NieruchomoscDAL::$id_oferta => $_SESSION[NieruchomoscDAL::$id_oferta]), $ilosc_wierszy);
        ...
        $wynik = $dal->PodajOpisOferta(array(NieruchomoscDAL::$id_oferta => $_SESSION[NieruchomoscDAL::$id_oferta]), $ilosc_wierszy);
        echo '<form method="POST" action="'.$_SERVER['PHP_SELF'].'"><table>';
        KontrolkiHtml::DodajHidden(NieruchomoscDAL::$id_oferta, NieruchomoscDAL::$id_oferta, $_SESSION[NieruchomoscDAL::$id_oferta]);
