...
<?php
    ...
    else
    {
        ...
        {
            $tabParametr[KlientDAL::$id_klient] = $_POST[NieruchomoscDAL::$id_klient];
        ...
        KontrolkiHtml::DodajHidden(NieruchomoscDAL::$id_klient, NieruchomoscDAL::$id_klient, $_SESSION[NieruchomoscDAL::$id_klient]);
        ...
        $wynik = $dal->PodajNotatkaKlient(array(KlientDAL::$id_klient => $_SESSION[NieruchomoscDAL::$id_klient]), $ilosc_wierszy);
        if($ilosc_wierszy > 0)
        {
