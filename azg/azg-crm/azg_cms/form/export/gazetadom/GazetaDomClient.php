    ...
    class GazetaDom
    {
        ...
        */
        ...
        public function WyslijOferty()
        {
            ...
            //echo $this->nazwa_wys_plik;
            //echo $this->ftpUrl.$this->nazwa_wys_plik;
            
            //////copy($this->nazwa_wys_plik, $this->ftpUrl.$this->nazwa_wys_plik); //kopiowalem xml a nie zip, ale jako zip .......
            
            //$handle = ftp_connect($this->ftpUrl);
            //aftp_pasv ($handle, true);
            //$rezulatat = ftp_put($handle, $this->nazwa_wys_plik, $this->nazwa_wys_plik, FTP_BINARY);
            //ftp_close($handle);
            //copy($this->plik, '/home/bartek/ozyrys_dysk2/azg/azg_cms/form/export/domiporta/'.$this->plik);
        }
    }
?>