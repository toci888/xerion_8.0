...
$wiec1 = "&nbsp;<b>Link:</b> <a href = http://$wwwbiu/index.php?action=wynajemmzd&nu=$id1>mehr ....</a>";
...
if ($cenm1 != '0') {
$cename1 = "&nbsp;<b>Zusätzliche Gebühren:</b> $cenm1<br>";
}
else {
$cename1 = "";
}
...
<LINK REL=stylesheet HREF=http://www.web.azg.pl/form/azgf.css>
</HEAD>
...
$wiec1d = "&nbsp;<b>Link:</b> <a href = http://$wwwbiu/index.php?action=wynajemdzd&nu=$id1d>mehr ....</a>";
...
if ($cenm1d != '0') {
$cename1d = "&nbsp;<b>Zusätzliche Gebühren:</b> $cenm1d<br>";
}
else {
$cename1d = "";
}
...
$wiec1l = "&nbsp;<b>Link:</b> <a href = http://$wwwbiu/index.php?action=wynajemlzd&nu=$id1l>mehr ....</a>";
...
if ($cenm1l != '0') {
$cename1l = "&nbsp;<b>Zusätzliche Gebühren:</b> $cenm1l<br>";
}
else {
$cename1l = "";
}
...
$wiec1o = "&nbsp;<b>Link:</b> <a href = http://$wwwbiu/index.php?action=wynajemozd&nu=$id1o>mehr ....</a>";
...
if ($cenm1o != '0') {
$cename1o = "&nbsp;<b>Zusätzliche Gebühren:</b> $cenm1o<br>";
}
else {
$cename1o = "";
}
...
$wiec1dz = "&nbsp;<b>Link:</b> <a href = http://$wwwbiu/index.php?action=wynajemdzzd&nu=$id1dz>mehr ....</a>";
...
if ($cenm1dz != '0') {
$cename1dz = "&nbsp;<b>Zusätzliche Gebühren:</b> $cenm1dz<br>";
}
else {
$cename1dz = "";
}
...
<center>
<span class=nag1wbe>
MIETE VON GRUNDSTÜCKEN ANGEBOT
</span>
</center>
</td>
</tr>
...
$wiec1te = "&nbsp;<b>Link:</b> <a href = http://$wwwbiu/index.php?action=wynajemtezd&nu=$id1te>mehr ....</a>";
...
if ($cenm1te != '0') {
$cename1te = "&nbsp;<b>Zusätzliche Gebühren:</b> $cenm1te<br>";
}
else {
$cename1te = "";
}
