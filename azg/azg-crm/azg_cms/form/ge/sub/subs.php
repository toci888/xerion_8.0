...
$sql1 = "select id_m, no_m, lok_m, lok_w, lok_p, lp_m, powuzyt_m, np_m, wys_cz_m, cz_prze_m, std, cm_m2, cm_m, zd1, zd2, wyl_m from tab_mie where datawp_m = '$nowdate' and id_b = '$identbiura';";
	...
	$sqlkm = "SELECT id_zg, rodz_zg, rodzn_zg, cena_zg_od, cena_zg_do, email_zg, data_zg FROM sub WHERE rodz_zg  = 'K' and rodzn_zg = 'M' and cena_zg_od  <= '$cena1' and cena_zg_do >= '$cena1' and id_b = '$identbiura';";
...
$sqlofe = "SELECT nazwa_b, adres_b, tel_b, fax_b, tel_kom_b, email_b, www_b FROM tab_biur where id_b = '$identbiura';";
	...
	$resultofe = @pg_Exec($conn, $sqlofe);
		...
		$yourname = $nazbiu;
		$subject = "SUBSKRIPTION DES IMMOBILESBÜROS";
		$youremail = $emailbiu;
...
$wiec1 = "&nbsp;<b>Link do strony:</b> <a href = http://$wwwbiu/index.php?action=sprzedazmzd&nu=$id1>wiêcej ...</a>";

if ($wylacznosc1 == "2") {
$wyl1 = "<center><span class=wyl>Ausschließlichkeit</span></center>";
}
else {
$wyl1 = "";
}
...
if ($numofe1 != '0') {
$numofer1 = "&nbsp;<b>Nummer:</b> $numofe1<br>";
}
else {
$numofer1 = "";
}
...
if ($lok1 != '0') {
$lokpo1 = "&nbsp;<b>Lokalisation:</b> $lok1<br>";
}
else {
$lokpo1 = "";
}
...
if ($lokw1 != '0') {
$lokwoj1 = "<b>&nbsp;Woiwodschaft:</b> $wojns<br>";
}
else {
$lokwoj1 = "";
}
...
if ($powuzyt1 != '0') {
$powpo1 = "&nbsp;<b>Nutzfläche:</b> $powuzyt1 m2<br>";
}
else {
$powpo1 = "";
}
...
if ($cza1 != '0') {
$czas1 = "&nbsp;<b>Überlieferungszeit:</b> $czasps<br>";
}
else {
$czas1 = "";
}
...
if ($cenm1 != '0') {
$cename1 = "&nbsp;<b>Preis für 1 m2:</b> $cenm1 z³.<br>";
}
else {
$cename1 = "";
}
...
<td width=128 height=70>
	<center>
	<a href = http://$wwwbiu/index.php?action=sprzedazmzd&nu=$id1>
	<img src=http://$wwwbiu/img/zd$zdj1.jpg width=125 height=100 border=0 alt=Foto nr$zdj1></img></a><br>
	</center>
</td>";
...
<td width=128 height=70>
	<center>
	<a href = http://$wwwbiu/index.php?action=sprzedazmzd&nu=$id1>
	<img src=http://$wwwbiu/img/zd$zdj2.jpg width=125 height=100 border=0 alt=Foto nr$zdj2></img></a><br>
	</center>
</td>";
...
IMMOBILESBÜROS A.Z.GWARANCJA<br>
</span>
</td>
</tr>
...
<span class=tytul><b>
str. Sosnkowskiego 40-42, 45-284 Opole<br>
...
<span class=tytul><b>
str. Bytnara Rudego 13, 45-265 Opole<br>
tel./fax. +48 77 458-00-94, 0602-531-334<br>
</b>
</span>
</td>
</tr>
...
$sql2 = "select id_d, no_d, lok_d, lok_w, lok_p, rof_d, powdzi_d, powuzyt_d, wysop_d, cz_prze_d, std_d, cm2_d, cd, zd1, zd2, wyl_d from tab_dom where datawp_d = '$nowdate' and id_b = '$identbiura';";
...
$rows2 = pg_NumRows($result_set2);		// liczba zwroconych wierszy
	...
	$sqlkd = "SELECT id_zg, rodz_zg, rodzn_zg, cena_zg_od, cena_zg_do, email_zg, data_zg FROM sub WHERE rodz_zg  = 'K' and rodzn_zg = 'D' and cena_zg_od  <= '$cena1d' and cena_zg_do >= '$cena1d' and id_b = '$identbiura';";
...
$sqlofe = "SELECT nazwa_b, adres_b, tel_b, fax_b, tel_kom_b, email_b, www_b FROM tab_biur where id_b = '$identbiura';";
	...
	$resultofe = @pg_Exec($conn, $sqlofe);
		...
		$yournamed = $nazbiu;
		$subjectd = "SUBSKRIPTION DES IMMOBILESBÜROS";
		$youremaild = $emailbiu;
...
$wiec1d = "&nbsp;<b>Link:</b> <a href = http://$wwwbiu/index.php?action=sprzedazdzd&nu=$id1d>mehr ...</a>";

if ($wylacznosc1d == "2") {
$wyl1d = "<center><span class=wyl>Ausschließlichkeit</span></center>";
}
else {
$wyl1d = "";
}
...
if ($numofe1d != '0') {
$numofer1d = "&nbsp;<b>Nummer:</b> $numofe1d<br>";
}
else {
$numofer1d = "";
}
...
if ($lok1d != '0') {
$lokpo1d = "&nbsp;<b>Lokalisation:</b> $lok1d<br>";
}
else {
$lokpo1d = "";
}
...
if ($lokw1d != '0') {
$lokwoj1d = "<b>&nbsp;Woiwodschaft:</b> $wojnsd<br>";
}
else {
$lokwoj1d = "";
}
...
if ($lokp1d != '0') {
$lokpow1d = "&nbsp;<b>Kreis:</b> $powiatnsd<br>";
}
else {
$lokpow1d = "";
}
...
if ($rofd1d != '0') {
$rofdo1d = "&nbsp;<b>Angebotsart:</b> $profnsd<br>";
}
else {
$rofdo1d = "";
}
...
if ($powuzyt1d != '0') {
$powpo1d = "&nbsp;<b>Nutzfläche:</b> $powuzyt1d m2<br>";
}
else {
$powpo1d = "";
}
...
if ($powdzia1d != '0') {
$powdzial1d = "&nbsp;<b>Grundstückfläche:</b> $powdzia1d ar<br>";
}
else {
$powdzial1d = "";
}
...
if ($cza1d != '0') {
$czas1d = "&nbsp;<b>Überlieferungszeit:</b> $czaspsd<br>";
}
else {
$czas1d = "";
}
...
if ($cenm1d != '0') {
$cename1d = "&nbsp;<b>Preis für 1 m2:</b> $cenm1d z³.<br>";
}
else {
$cename1d = "";
}
...
<td width=128 height=70>
	<center>
	<a href = http://$wwwbiu/index.php?action=sprzedazdzd&nu=$id1d>
	<img src=http://$wwwbiu/img/zd$zdj1d.jpg width=125 height=100 border=0 alt=Foto nr$zdj1d></img></a><br>
	</center>
</td>";
...
<td width=128 height=70>
	<center>
	<a href = http://$wwwbiu/index.php?action=sprzedazdzd&nu=$id1d>
	<img src=http://$wwwbiu/img/zd$zdj2d.jpg width=125 height=100 border=0 alt=Foto nr$zdj2d></img></a><br>
	</center>
</td>";
...
$sql3 = "select id_d, no_d, lok_d, lok_w, lok_p, rof_d, powdzi_d, powuzyt_d, wysop_d, cz_prze_d, std_d, cm2_d, cd, zd1, zd2, wyl_d from tab_lok where datawp_d = '$nowdate' and id_b = '$identbiura';";
...
$rows3 = pg_NumRows($result_set3);		// liczba zwroconych wierszy
	...
	$sqlkl = "SELECT id_zg, rodz_zg, rodzn_zg, cena_zg_od, cena_zg_do, email_zg, data_zg FROM sub WHERE rodz_zg  = 'K' and rodzn_zg = 'L' and cena_zg_od  <= '$cena1l' and cena_zg_do >= '$cena1l' and id_b = '$identbiura';";
...
$sqlofe = "SELECT nazwa_b, adres_b, tel_b, fax_b, tel_kom_b, email_b, www_b FROM tab_biur where id_b = '$identbiura';";
	...
	$resultofe = @pg_Exec($conn, $sqlofe);
		...
		$yournamel = $nazbiu;
		$subjectl = "SUBSKRIPTION DES IMMOBILESBÜROS";
		$youremaill = $emailbiu;
...
$wiec1l = "&nbsp;<b>Link:</b> <a href = http://$wwwbiu/index.php?action=sprzedazlzd&nu=$id1l>mehr ...</a>";

if ($wylacznosc1l == "2") {
$wyl1l = "<center><span class=wyl>Ausschließlichkeit</span></center>";
}
else {
$wyl1l = "";
}
...
if ($numofe1l != '0') {
$numofer1l = "&nbsp;<b>Nummer:</b> $numofe1l<br>";
}
else {
$numofer1l = "";
}
...
if ($lok1l != '0') {
$lokpo1l = "&nbsp;<b>Lokalisation:</b> $lok1l<br>";
}
else {
$lokpo1l = "";
}
...
if ($lokw1l != '0') {
$lokwoj1l = "<b>&nbsp;Woiwodschaft:</b> $wojnsl<br>";
}
else {
$lokwoj1l = "";
}
...
if ($lokp1l != '0') {
$lokpow1l = "&nbsp;<b>Kreis:</b> $powiatnsl<br>";
}
else {
$lokpow1l = "";
}
...
if ($rofd1l != '0') {
$rofdo1l = "&nbsp;<b>Angebotsart:</b> $profnsl<br>";
}
else {
$rofdo1l = "";
}
...
if ($powuzyt1l != '0') {
$powpo1l = "&nbsp;<b>Nutzfläche:</b> $powuzyt1l m2<br>";
}
else {
$powpo1l = "";
}
...
if ($powdzia1l != '0') {
$powdzial1l = "&nbsp;<b>Grundstückfläche:</b> $powdzia1l ar<br>";
}
else {
$powdzial1l = "";
}
...
if ($cza1l != '0') {
$czas1l = "&nbsp;<b>Überlieferungszeit:</b> $czaspsl<br>";
}
else {
$czas1l = "";
}
...
if ($cenm1l != '0') {
$cename1l = "&nbsp;<b>Preis für 1 m2:</b> $cenm1l z³.<br>";
}
else {
$cename1l = "";
}
...
<td width=128 height=70>
	<center>
	<a href = http://$wwwbiu/index.php?action=sprzedazlzd&nu=$id1l>
	<img src=http://$wwwbiu/img/zd$zdj1l.jpg width=125 height=100 border=0 alt=Foto nr$zdj1l></img></a><br>
	</center>
</td>";
...
<td width=128 height=70>
	<center>
	<a href = http://$wwwbiu/index.php?action=sprzedazlzd&nu=$id1l>
	<img src=http://$wwwbiu/img/zd$zdj2l.jpg width=125 height=100 border=0 alt=Foto nr$zdj2l></img></a><br>
	</center>
</td>";
...
$sql4 = "select id_d, no_d, lok_d, lok_w, lok_p, rof_d, powdzi_d, powuzyt_d, wysop_d, cz_prze_d, std_d, cm2_d, cd, zd1, zd2, wyl_d from tab_obi where datawp_d = '$nowdate' and id_b = '$identbiura';";
...
$rows4 = pg_NumRows($result_set4);		// liczba zwroconych wierszy
	...
	$sqlko = "SELECT id_zg, rodz_zg, rodzn_zg, cena_zg_od, cena_zg_do, email_zg, data_zg FROM sub WHERE rodz_zg  = 'K' and rodzn_zg = 'O' and cena_zg_od  <= '$cena1o' and cena_zg_do >= '$cena1o' and id_b = '$identbiura';";
...
$sqlofe = "SELECT nazwa_b, adres_b, tel_b, fax_b, tel_kom_b, email_b, www_b FROM tab_biur where id_b = '$identbiura';";
	...
	$resultofe = @pg_Exec($conn, $sqlofe);
		...
		$yournamel = $nazbiu;
		$subjecto = "SUBSKRIPTION DES IMMOBILESBÜROS";
		$youremaill = $emailbiu;
...
$wiec1o = "&nbsp;<b>Link:</b> <a href = http://$wwwbiu/index.php?action=sprzedazozd&nu=$id1o>mehr ...</a>";

if ($wylacznosc1o == "2") {
$wyl1o = "<center><span class=wyl>Ausschließlichkeit</span></center>";
}
else {
$wyl1o = "";
}
...
if ($numofe1o != '0') {
$numofer1o = "&nbsp;<b>Nummer:</b> $numofe1o<br>";
}
else {
$numofer1o = "";
}
...
if ($lok1o != '0') {
$lokpo1o = "&nbsp;<b>Lokalisation:</b> $lok1o<br>";
}
else {
$lokpo1o = "";
}
...
if ($lokw1o != '0') {
$lokwoj1o = "<b>&nbsp;Woiwodschaft:</b> $wojnso<br>";
}
else {
$lokwoj1o = "";
}
...
if ($lokp1o != '0') {
$lokpow1o = "&nbsp;<b>Kreis:</b> $powiatnso<br>";
}
else {
$lokpow1o = "";
}
...
if ($rofd1o != '0') {
$rofdo1o = "&nbsp;<b>Angebotsart:</b> $profnso<br>";
}
else {
$rofdo1o = "";
}
...
if ($powuzyt1o != '0') {
$powpo1o = "&nbsp;<b>Nutzfläche:</b> $powuzyt1o m2<br>";
}
else {
$powpo1o = "";
}
...
if ($powdzia1o != '0') {
$powdzial1o = "&nbsp;<b>Grundstückfläche:</b> $powdzia1o ar<br>";
}
else {
$powdzial1o = "";
}
...
if ($cza1o != '0') {
$czas1o = "&nbsp;<b>Überlieferungszeit:</b> $czaspso<br>";
}
else {
$czas1o = "";
}
...
if ($cenm1o != '0') {
$cename1o = "&nbsp;<b>Preis für 1 m2:</b> $cenm1o z³.<br>";
}
else {
$cename1o = "";
}
...
<td width=128 height=70>
	<center>
	<a href = http://$wwwbiu/index.php?action=sprzedazozd&nu=$id1o>
	<img src=http://$wwwbiu/img/zd$zdj1o.jpg width=125 height=100 border=0 alt=Foto nr$zdj1o></img></a><br>
	</center>
</td>";
...
<td width=128 height=70>
	<center>
	<a href = http://$wwwbiu/index.php?action=sprzedazozd&nu=$id1o>
	<img src=http://$wwwbiu/img/zd$zdj2o.jpg width=125 height=100 border=0 alt=Foto nr$zdj2o></img></a><br>
	</center>
</td>";
...
$sql5 = "select id_d, no_d, lok_d, lok_w, lok_p, rof_d, powdzi_d, wysop_d, cz_prze_d, cm2_d, cd, zd1, zd2, wyl_d from tab_dzi  where datawp_d = '$nowdate' and id_b = '$identbiura';;";
...
$rows5 = pg_NumRows($result_set5);		// liczba zwroconych wierszy
	...
	$sqlkdz = "SELECT id_zg, rodz_zg, rodzn_zg, cena_zg_od, cena_zg_do, email_zg, data_zg FROM sub WHERE rodz_zg  = 'K' and rodzn_zg = 'Dz' and cena_zg_od  <= '$cena1dz' and cena_zg_do >= '$cena1dz' and id_b = '$identbiura';";
...
$sqlofe = "SELECT nazwa_b, adres_b, tel_b, fax_b, tel_kom_b, email_b, www_b FROM tab_biur where id_b = '$identbiura';";
	...
	$resultofe = @pg_Exec($conn, $sqlofe);
		...
		$yourname = $nazbiu;
		$subjectdz = "SUBSKRIPTION DES IMMOBILESBÜROS";
		$youremail = $emailbiu;
...
$wiec1dz = "&nbsp;<b>Link:</b> <a href = http://$wwwbiu/index.php?action=sprzedazdzzd&nu=$id1dz>mehr ...</a>";

if ($wylacznosc1dz == "2") {
$wyl1dz = "<center><span class=wyl>Ausschließlichkeit</span></center>";
}
else {
$wyl1dz = "";
}
...
if ($numofe1dz != '0') {
$numofer1dz = "&nbsp;<b>Nummer:</b> $numofe1dz<br>";
}
else {
$numofer1dz = "";
}
...
if ($lok1dz != '0') {
$lokpo1dz = "&nbsp;<b>Lokalisation:</b> $lok1dz<br>";
}
else {
$lokpo1dz = "";
}
...
if ($lokw1dz != '0') {
$lokwoj1dz = "<b>&nbsp;Woiwodschaft:</b> $wojnsdz<br>";
}
else {
$lokwoj1dz = "";
}
...
if ($lokp1dz != '0') {
$lokpow1dz = "&nbsp;<b>Kreis:</b> $powiatnsdz<br>";
}
else {
$lokpow1dz = "";
}
...
if ($rofd1dz != '0') {
$rofdo1dz = "&nbsp;<b>Angebotsart:</b> $profnsdz<br>";
}
else {
$rofdo1dz = "";
}
...
if ($powdzia1dz != '0') {
$powdzial1dz = "&nbsp;<b>Grundstückfläche:</b> $powdzia1dz ar<br>";
}
else {
$powdzial1dz = "";
}
...
if ($wys1dz != '0') {
$wyscz1dz = "&nbsp;<b>Miete:</b> $wys1dz z³.<br>";
}
else {
$wyscz1dz = "";
}
...
if ($cza1dz != '0') {
$czas1dz = "&nbsp;<b>Überlieferungszeit:</b> $czaspsdz<br>";
}
else {
$czas1dz = "";
}
...
if ($cenm1dz != '0') {
$cename1dz = "&nbsp;<b>Preis za 1 ar:</b> $cenm1dz z³.<br>";
}
else {
$cename1dz = "";
}
...
if ($cena1dz != '0') {
$cenpo1dz = "&nbsp;<b>Preis:</b> $cena1dz z³.<br>";
}
else {
$cenpo1dz = "";
}
...
<td width=128 height=70>
	<center>
	<a href = http://$wwwbiu/index.php?action=sprzedazdzzd&nu=$id1dz>
	<img src=http://$wwwbiu/img/zd$zdj1dz.jpg width=125 height=100 border=0 alt=Foto nr$zdj1dz></img></a><br>
	</center>
</td>";
...
<td width=128 height=70>
	<center>
	<a href = http://$wwwbiu/index.php?action=sprzedazdzzd&nu=$id1dz>
	<img src=http://$wwwbiu/img/zd$zdj2dz.jpg width=125 height=100 border=0 alt=Foto nr$zdj2dz></img></a><br>
	</center>
</td>";
...
<center>
<span class=nag1wbe>
VERKAUF VON GRUNDSTÜCKEN ANGEBOT
</span>
</center>
</td>
</tr>
...
$sql6 = "select id_d, no_d, lok_d, lok_w, lok_p, rof_d, powdzi_d, wysop_d, cz_prze_d, cm2_d, cd, zd1, zd2, wyl_d from tab_te  where datawp_d = '$nowdate' and id_b = '$identbiura';;";
...
$rows6 = pg_NumRows($result_set6);		// liczba zwroconych wierszy
	...
	$sqlkte = "SELECT id_zg, rodz_zg, rodzn_zg, cena_zg_od, cena_zg_do, email_zg, data_zg FROM sub WHERE rodz_zg  = 'K' and rodzn_zg = 'T' and cena_zg_od  <= '$cena1te' and cena_zg_do >= '$cena1te' and id_b = '$identbiura';";
...
$sqlofe = "SELECT nazwa_b, adres_b, tel_b, fax_b, tel_kom_b, email_b, www_b FROM tab_biur where id_b = '$identbiura';";
	...
	$resultofe = @pg_Exec($conn, $sqlofe);
		...
		$yourname = $nazbiu;
		$subjectte = "SUBSKRIPTION DES IMMOBILESBÜROS";
		$youremail = $emailbiu;
...
$wiec1te = "&nbsp;<b>Link:</b> <a href = http://$wwwbiu/index.php?action=sprzedaztezd&nu=$id1te>mehr ...</a>";

if ($wylacznosc1te == "2") {
$wyl1te = "<center><span class=wyl>Ausschließlichkeit</span></center>";
}
else {
$wyl1te = "";
}
...
if ($numofe1te != '0') {
$numofer1te = "&nbsp;<b>Nummer:</b> $numofe1te<br>";
}
else {
$numofer1te = "";
}
...
if ($lok1te != '0') {
$lokpo1te = "&nbsp;<b>Lokalisation:</b> $lok1te<br>";
}
else {
$lokpo1te = "";
}
...
if ($lokw1te != '0') {
$lokwoj1te = "<b>&nbsp;Woiwodschaft:</b> $wojnste<br>";
}
else {
$lokwoj1te = "";
}
...
if ($lokp1te != '0') {
$lokpow1te = "&nbsp;<b>Kreis:</b> $powiatnste<br>";
}
else {
$lokpow1te = "";
}
...
if ($rofd1te != '0') {
$rofdo1te = "&nbsp;<b>Angebotsart:</b> $profnste<br>";
}
else {
$rofdo1te = "";
}
...
if ($powdzia1te != '0') {
$powdzial1te = "&nbsp;<b>Grundstückfläche:</b> $powdzia1te ar<br>";
}
else {
$powdzial1te = "";
}
...
if ($wys1te != '0') {
$wyscz1te = "&nbsp;<b>Miete:</b> $wys1te z³.<br>";
}
else {
$wyscz1te = "";
}
...
if ($cza1te != '0') {
$czas1te = "&nbsp;<b>Überlieferungszeit:</b> $czaspste<br>";
}
else {
$czas1te = "";
}
...
if ($cenm1te != '0') {
$cename1te = "&nbsp;<b>Preis za 1 ar:</b> $cenm1te z³.<br>";
}
else {
$cename1te = "";
}
...
if ($cena1te != '0') {
$cenpo1te = "&nbsp;<b>Preis:</b> $cena1te z³.<br>";
}
else {
$cenpo1te = "";
}
...
<td width=128 height=70>
	<center>
	<a href = http://$wwwbiu/index.php?action=sprzedaztezd&nu=$id1te>
	<img src=http://$wwwbiu/img/zd$zdj1te.jpg width=125 height=100 border=0 alt=Foto nr$zdj1te></img></a><br>
	</center>
</td>";
...
<td width=128 height=70>
	<center>
	<a href = http://$wwwbiu/index.php?action=sprzedaztezd&nu=$id1te>
	<img src=http://$wwwbiu/img/zd$zdj2te.jpg width=125 height=100 border=0 alt=Foto nr$zdj2te></img></a><br>
	</center>
</td>";
