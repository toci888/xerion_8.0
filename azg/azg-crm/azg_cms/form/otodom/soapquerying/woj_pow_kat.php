<?
    ...
    where ".$klucz_pod." = '$idut' and kategorie_allegro.sprzedaz = 'true' and kategorie_allegro.id_rodzaj_nieruchomosci = (select id from rodzaj_nieruchomosci where nazwa = '".$rodzaj_nier."');";
