...
//scalenie do jednego zapytania tych informacji jest mozliwe, pozwala na optymalizacje, gdyz postgres odpowie na zapytanie blyskawicznie, 
//zas odpalanie 4 apytan powoduje opoznienia podczas komunikacji z baza, dlatego trwa dluzej, stad moja sugestia, zeby to upakowac
//do 1 zapytania, pytanie czy sa ewentualnie jakies przeciwwskazania
...
$cenam2s = "$cenam2 z³.";
    ...
    $offerId = $otoDom->InsertOffer(null, $future, $wojn_otodom, $powiatn_otodom, $miast, $dzieln, $numof, $cenami, $powuzy, $prawnyss, $dodop, 
    $wyspos, $structure, $mediaTab, $heating, $parking, $surrTab, array($poko1, $poko2, $poko3, $poko4, $poko5, $poko6), $numerpie, $robups, 
    $liczbapie, $lipok, $stanps, $rokbus, array($ogrzeps), $offerType, $localization, $kat_allegro, $zdOtodom, $accTab, null);
    
    InsertionOtoDom($conn, $rodzaj_nier, $nowdates, $offerId, $idut, $future);
