<?php
    ...
    class WyposazenieNierBLL
    {
        ...
        /**
        * Metoda przeznaczona do podania tablicy zawierajacej wszystkie sekcje, w strukturze id => nazwa sekcji
        *
        * @param    brak
        * @access publiczna
        */
        ...
        /**
        * Metoda przeznaczona do podania tablicy zawierajacej liste pomieszczen danej nieruchomosci, struktura id => nazwa
        *
        * @param    brak
        * @access publiczna
        */
        ...
        /**
        * Metoda podaje kolekcje wyposazen dla wszyskich sekcji; kolekcja ta jest indexowana id sekcji
        *
        * @param    brak
        * @access publiczna
        */
        ...
        /**
        * Metoda przeznaczona do podania kompletnej kolekcji parametrow podzielonej na sekcje wgledem id sekcji
        *
        * @param    brak
        * @access publiczna
        */
        ...
        {                                        
            ...
            while(isset($wynik[$i]))
            {
                ...
                else
                {
                    $this->ElementKolekcji->ZatwierdzWyposazenie();
                    //tu if czy sa dane edycyjne
                    if (is_array($this->daneBaza[WyposazenieZapDAL::$dane_wyposazenie_zap]))
                    {
