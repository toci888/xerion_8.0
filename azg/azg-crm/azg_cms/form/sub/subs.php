...
//$sql1 = "select id_m, no_m, lok_m, lok_w, lok_p, lp_m, powuzyt_m, np_m, wys_cz_m, cz_prze_m, std, cm_m2, cm_m, zd1, zd2, wyl_m from tab_mie where id_b = '$identbiura';";
...
if ($cenm1 != '0') {
$cename1 = "&nbsp;<b>Cena za 1 m2:</b> $cenm1 z³.<br>";
}
else {
$cename1 = "";
}
...
<LINK REL=stylesheet HREF=http://www.azg.pl/azgf.css>
</HEAD>
...
<img src=http://www.azg.pl/logom.jpg width=181 height=90 border=0></img>
...
<td width=2% height=100% align=right><img src=http://www.azg.pl/black.gif width=1 height=100% border=0></td>
...
adres: <a href = http://www.azg.pl>www.azg.pl</a>, e-mail: <a href= mailto:azgwarancja@azg.pl>azgwarancja@azg.pl</a>
	...
	<tr>
	<td colspan = 4><img src=http://www.azg.pl/black.gif width=100% height=2 border=0></td>
	</tr>

</table>
<br>
<table width=100% cellpadding=0 cellspacing=0 frame border=0 valign=center>
<tr><td><img src=http://www.azg.pl/black.gif width=100% height=1 border=0></td></tr>
<tr valign=center>
<td height=7 bgcolor=#5865E5 colspan=3>
<center>
<span class=nag1wbe>
OFERTA SPRZEDA¯Y MIESZKANIA
</span>
</center>
</td>
</tr>
...
$wiec1d = "&nbsp;<b>Link do strony:</b> <a href = http://$wwwbiu/index.php?action=sprzedazdzd&nu=$id1d>wiêcej ...</a>";
...
if ($cenm1d != '0') {
$cename1d = "&nbsp;<b>Cena za 1 m2:</b> $cenm1d z³.<br>";
}
else {
$cename1d = "";
}
...
$wiec1l = "&nbsp;<b>Link do strony:</b> <a href = http://$wwwbiu/index.php?action=sprzedazlzd&nu=$id1l>wiêcej ...</a>";
...
if ($cenm1l != '0') {
$cename1l = "&nbsp;<b>Cena za 1 m2:</b> $cenm1l z³.<br>";
}
else {
$cename1l = "";
}
...
$wiec1o = "&nbsp;<b>Link do strony:</b> <a href = http://$wwwbiu/index.php?action=sprzedazozd&nu=$id1o>wiêcej ...</a>";
...
if ($cenm1o != '0') {
$cename1o = "&nbsp;<b>Cena za 1 m2:</b> $cenm1o z³.<br>";
}
else {
$cename1o = "";
}
...
$wiec1dz = "&nbsp;<b>Link do strony:</b> <a href = http://$wwwbiu/index.php?action=sprzedazdzzd&nu=$id1dz>wiêcej ...</a>";
...
if ($cenm1dz != '0') {
$cename1dz = "&nbsp;<b>Cena za 1 ar:</b> $cenm1dz z³.<br>";
}
else {
$cename1dz = "";
}
...
$wiec1te = "&nbsp;<b>Link do strony:</b> <a href = http://$wwwbiu/index.php?action=sprzedaztezd&nu=$id1te>wiêcej ...</a>";
...
if ($cenm1te != '0') {
$cename1te = "&nbsp;<b>Cena za 1 ar:</b> $cenm1te z³.<br>";
}
else {
$cename1te = "";
}
