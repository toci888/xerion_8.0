...
<?php
    ...
    else
    {
        ...
        { 
            ...
            UtilsUI::WyswietlTab1Poz($wynik, array(ListaWskazanDAL::$id_oferta, NieruchomoscDAL::$nieruchomosc_rodzaj, NieruchomoscDAL::$transakcja_rodzaj, NieruchomoscDAL::$status, NieruchomoscDAL::$agent, ListaWskazanDAL::$cena, 
            ListaWskazanDAL::$ulica, ListaWskazanDAL::$ogladanie_data, MediaDAL::$powierzchnia, ExportDAL::$liczba_pokoi),
            array(tags::$nr_oferty, tags::$rodzaj_nieruchomosci, tags::$rodzaj_transakcja, tags::$status, tags::$agent, tags::$cena, tags::$ulica, tags::$data, tags::$powierzchnia, tags::$liczba_pokoi), 
