    ...
    else
    {
        ...
        if ($uprawnienia->adm_dane)
        {
            ...
            if (isset($_POST['zatwierdz']))
            {
                ...
                $tabParametr[AdministracjaDAL::$nazwa] = $_POST['tlumaczenie'.$_POST['wyb_slowo']];
            ...
            if (isset($_POST['podaj_wyrazenia']))
            {
                ...
                if ($ilosc_wierszy > 0)
                {
                    ...
                    foreach ($wynik as $wiersz)
                    {
                        ...
                        KontrolkiHtml::DodajTextbox('tlumaczenie'.$wiersz[AdministracjaDAL::$nazwa], 'tlumaczenie'.$wiersz[AdministracjaDAL::$nazwa], '', 100, 50, '');
                        echo '</td><td>';
