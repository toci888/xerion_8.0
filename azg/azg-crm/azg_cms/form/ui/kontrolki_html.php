<?php
  ...
  class KontrolkiHtml 
  {
      public static function DodajZdjNierStrona ($sciezka_zdjecie, $id_nier_rodzaj, $id_oferta, $width, $height, $lokalizacja = '')
      {
          ...
          //w 90 h 60
          //alt="'.
          //UtilsUI::KonwersjaEncoding($tlumaczenia->Tlumacz($_SESSION[$jezyk], tags::$zdjecie_nieruchomosci), $_SESSION[$jezyk]).'"
          $str = '<img src="'.$sciezka_zdjecie.'" width="'.$width.'" height="'.$height.'" border="0" class="ira" title="'.
          UtilsUI::KonwersjaEncoding($tlumaczenia->Tlumacz($_SESSION[$jezyk], tags::$nieruchomosci), $_SESSION[$jezyk]).' '.$lokalizacja.': '.
          UtilsUI::KonwersjaEncoding($tlumaczenia->Tlumacz($_SESSION[$jezyk], $t_nier_r[$id_nier_rodzaj]), $_SESSION[$jezyk]).' - '.
          UtilsUI::KonwersjaEncoding($tlumaczenia->Tlumacz($_SESSION[$jezyk], tags::$numer_oferty), $_SESSION[$jezyk]).': '.$id_oferta.'." alt="'.
          UtilsUI::KonwersjaEncoding($tlumaczenia->Tlumacz($_SESSION[$jezyk], tags::$nieruchomosci), $_SESSION[$jezyk]).' '.$lokalizacja.': '.
          UtilsUI::KonwersjaEncoding($tlumaczenia->Tlumacz($_SESSION[$jezyk], $t_nier_r[$id_nier_rodzaj]), $_SESSION[$jezyk]).', '.
          UtilsUI::KonwersjaEncoding($tlumaczenia->Tlumacz($_SESSION[$jezyk], tags::$numer_oferty), $_SESSION[$jezyk]).': '.$id_oferta.'."></img>';
      ...
      */
      ...
      public static function DodajEmailTextbox($name, $id, $value, $length, $size, $onblur, $validation, $wymagane = false)
      {
          ...
          \''.UtilsUI::KonwersjaEncoding($tlumaczenia->Tlumacz($_SESSION[$jezyk], tags::$bledny_e_mail), $_SESSION[$jezyk]).'\');'.
          $onblur.'" '.$validation.'>';
          echo $str;
      }
