        ...
        if ($dal != null)
        {
            ...
            {                
                foreach ($wynik as $wiersz)
                {
                    ...
                    KontrolkiHtml::DodajTextbox('opis_tel'.$wiersz[OsobaDAL::$id], 'id_opis_tel'.$wiersz[OsobaDAL::$id], $wiersz[OsobaDAL::$opis], 50, 20, '');
                    echo '</td><td>';
            ...
            echo '</td><td>'.$tlumaczenia->Tlumacz($_SESSION[$jezyk], tags::$opis).' : </td><td>';
            KontrolkiHtml::DodajTextbox('opis_tel', 'id_opis_tel', '', 50, 20, '');
            echo '</td><td>';
            ...
            echo '</td><td>'.$tlumaczenia->Tlumacz($_SESSION[$jezyk], tags::$opis).' : </td><td>';
            KontrolkiHtml::DodajTextbox('opis_kom', 'id_opis_kom', $opis_kom, 50, 20, '');
            echo '</td><td>';
            ...
            {                
                foreach ($wynik as $wiersz)
                {
                    ...
                    KontrolkiHtml::DodajEmailTextbox('mail'.$wiersz[OsobaDAL::$id], 'id_mail'.$wiersz[OsobaDAL::$id], $wiersz[OsobaDAL::$nazwa], 30, 20, '', '');
                    echo '</td><td>'.$tlumaczenia->Tlumacz($_SESSION[$jezyk], tags::$opis).' : </td><td>';
                    KontrolkiHtml::DodajTextbox('opis_mail'.$wiersz[OsobaDAL::$id], 'id_opis_mail'.$wiersz[OsobaDAL::$id], $wiersz[OsobaDAL::$opis], 50, 20, '');
                    echo '</td><td>';
            ...
            echo '<tr><td>'.$tlumaczenia->Tlumacz($_SESSION[$jezyk], tags::$adres_email).' : </td><td>';
            KontrolkiHtml::DodajEmailTextbox('mail', 'id_mail', '', 30, 20, '', '');
            echo '</td><td>'.$tlumaczenia->Tlumacz($_SESSION[$jezyk], tags::$opis).' : </td><td>';
            KontrolkiHtml::DodajTextbox('opis_mail', 'id_opis_mail', '', 50, 20, '');
            echo '</td><td>';
