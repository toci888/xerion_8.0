...
<?php
    ...
    else
    {
        ...
        if($ilosc_wierszy > 0)
        {
            ...
            NieruchomoscDAL::$cena),
            array(tags::$nr_zapotrzebowania, tags::$osoba, tags::$pesel, tags::$telefon, tags::$data, tags::$agent, tags::$cena_ogl), 
            ListaWskazanDAL::$id_lista_wsk_adr, 'lista_wsk_adr_id', null, array(tags::$transakcja), array(tags::$transakcja => tags::$transakcja), null, null, null);//array('zapotrzebowanie_id' => NieruchomoscDAL::$id_zapotrzebowanie)
