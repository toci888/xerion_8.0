...
<?php
    ...
    else
    {
        ...
        if ($klient_id != null)
        {
            ...
            if($ilosc_wierszy > 0)
            {
                UtilsUI::WyswietlTab1Poz($wynik, array(ListaWskazanDAL::$id_oferta, NieruchomoscDAL::$nieruchomosc_rodzaj, NieruchomoscDAL::$transakcja_rodzaj, ListaWskazanDAL::$cena, ListaWskazanDAL::$cena_ogl, ListaWskazanDAL::$ulica, 
                ListaWskazanDAL::$ogladanie_data, MediaDAL::$powierzchnia, ExportDAL::$liczba_pokoi),
                array(tags::$nr_oferty, tags::$rodzaj_nieruchomosci, tags::$rodzaj_transakcja, tags::$cena, tags::$cena_ogl, tags::$ulica, tags::$data, tags::$powierzchnia, tags::$liczba_pokoi), 
