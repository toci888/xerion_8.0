...
<?php
    ...
    else
    {
        ...
        {
            //$wynik = SlownikDAL::RegionGeograficznyNajnizejWoj($_POST['region_szukaj'], $_POST['wojewodztwo_id']);
            $wynik = SlownikDAL::PobierzDowRegionGeog($_POST['wojewodztwo_id'], $_POST['region_szukaj']);
