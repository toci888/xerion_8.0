...
<?php
//var ARR_MONTHS = ["Styczeñ", "Luty", "Marzec", "Kwiecieñ", "Maj", "Czerwiec",
//		"Lipiec", "Sierpieñ", "Wrzesieñ", "PaŸdziernik", "Listopad", "Grudzieñ"];
echo 'var ARR_MONTHS = ["'.$tlumaczenia->Tlumacz($_SESSION[$jezyk], tags::$styczen).'", "'.$tlumaczenia->Tlumacz($_SESSION[$jezyk], tags::$luty).'", "'.$tlumaczenia->Tlumacz($_SESSION[$jezyk], tags::$marzec).'", 
"'.$tlumaczenia->Tlumacz($_SESSION[$jezyk], tags::$kwiecien).'", "'.$tlumaczenia->Tlumacz($_SESSION[$jezyk], tags::$maj).'", "'.$tlumaczenia->Tlumacz($_SESSION[$jezyk], tags::$czerwiec).'", 
"'.$tlumaczenia->Tlumacz($_SESSION[$jezyk], tags::$lipiec).'", "'.$tlumaczenia->Tlumacz($_SESSION[$jezyk], tags::$sierpien).'", "'.$tlumaczenia->Tlumacz($_SESSION[$jezyk], tags::$wrzesien).'", 
"'.$tlumaczenia->Tlumacz($_SESSION[$jezyk], tags::$pazdziernik).'", "'.$tlumaczenia->Tlumacz($_SESSION[$jezyk], tags::$listopad).'", "'.$tlumaczenia->Tlumacz($_SESSION[$jezyk], tags::$grudzien).'"];';
        ?>
// week day titles as they appear on the calendar
<?php
//var ARR_WEEKDAYS = ["Nie", "Pon", "Wt", "Œr", "Czw", "Pt", "Sob"];
echo 'var ARR_WEEKDAYS = ["'.$tlumaczenia->Tlumacz($_SESSION[$jezyk], tags::$nd).'", "'.$tlumaczenia->Tlumacz($_SESSION[$jezyk], tags::$pon).'", "'.$tlumaczenia->Tlumacz($_SESSION[$jezyk], tags::$wt).'", 
"'.$tlumaczenia->Tlumacz($_SESSION[$jezyk], tags::$sr).'", "'.$tlumaczenia->Tlumacz($_SESSION[$jezyk], tags::$czw).'", "'.$tlumaczenia->Tlumacz($_SESSION[$jezyk], tags::$pt).'", "'.$tlumaczenia->Tlumacz($_SESSION[$jezyk], tags::$sob).'"];';
?>
// day week starts from (normally 0-Nie or 1-Pon)
var NUM_WEEKSTART = 1;
...
var dt_current = (re_url.exec(String(window.location))
    ...
    //alert(new Date(new Number(RegExp.$1)));
