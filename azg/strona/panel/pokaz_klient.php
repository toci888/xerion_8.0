...
<?php
    ...
    else
    {
        ...
        ///to chyba juz zbedne stad zakomentowac - nie wiadomo co - zostalo zapewne wyrzucone
        ...
        if (isset($_POST['pokaz_klient']))
        {
            ...
            $tabParametr[NieruchomoscDAL::$id_klient] = $_POST[NieruchomoscDAL::$id_klient];
            $wynik = $dal->TransakcjeKlient($tabParametr, $ilosc_wierszy);
            if ($ilosc_wierszy > 0)
            {
