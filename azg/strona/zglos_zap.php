...
<?php
    ...
    <input type="hidden" name="target" value="zglos_zap">
    <INPUT TYPE="hidden" NAME="subject" VALUE="'.$tlumaczenia->Tlumacz($_SESSION[$jezyk], tags::$zapotrzebowanie).' - '.$AZG.'">';
    ...
    $trans_ar = array(array('id' => 1, 'nazwa' => tags::$kupno), array('id' => 2, 'nazwa' => tags::$najem), array('id' => 3, 'nazwa' => tags::$zamiana));
    KontrolkiHtml::DodajSelectDomWartId('Rodzajzgloszenia', 'id_transakcje', $trans_ar, StronaPodsInfoDAL::$id_trans_rodzaj.'zg_zap', null, '', '');
    ...
    KontrolkiHtml::DodajTextbox('Lokalizacja', 'id_Lokalizacja', '', 40, 25, '');
    ...
    <ul><li span class="polecam">'.$tlumaczenia->Tlumacz($_SESSION[$jezyk], tags::$po_prawidlowym_wypelnieniu_zapotrzebowania_przycisnij_przycisk).': &quot;'.
