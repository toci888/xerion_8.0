...
<?php
    ...
    echo '<table '.$atr_tab_srodek.'>'.UtilsUI::DodajTrListwaGlowna($tlumaczenia->Tlumacz($_SESSION[$jezyk], tags::$z_zycia_firmy));
    ...
    if (is_file('generator/z_zycia.php'))
    {
        require('generator/z_zycia.php');
    }
