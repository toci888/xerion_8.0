<?php
    ...
    $dl_lista_wsk = 800;
    $szer_lista_wsk = 790;
    //zmienna do szerokosci bocznych listewek strony (nowej)
    
    $atr_tab_srodek = 'width="100%" cellpadding="0" cellspacing="0" style="border: 1px solid black;"';
    
    $tab_nier_rodz = array(2 => tags::$mieszkania, 1 => tags::$domy, 4 => tags::$lokale, 3 => tags::$obiekty, 6 => tags::$dzialki, 5 => tags::$tereny);
    ...
    $wysokosc_strony = 590;//3016;
    $szer_boki_strona = 142;
    $szer_boki_strona_zewn = 155;//155;
    $szer_centr_strona = 640;
?>