<?php
    ...
    class StronaPodsInfoDAL
    {
        ...
        public function PodajDaneAgenci(&$ilosc_wierszy)
        {
            $zapytanie = 'select * from AgentOgolneDane;';
        ...
        public function RodzajOferta($id_trans_rodzaj, $id_nier_rodzaj, $zlecenie = false)
        {
            if ($zlecenie)
            {
                $zapytanie = 'select * from PodajRodzajZlecenie('.$id_nier_rodzaj.', '.$id_trans_rodzaj.');';
            }
            else
            {
        ...
        {
            $zapytanie = 'select * from PodajZdjecia('.$id_nieruchomosc.');';
            $wynik = $this->dal->PobierzDane($zapytanie, $ilosc_wierszy);
        ...
        {
            $zapytanie = 'select * from PodstawowaWersjaOfert('.$tabParametr[StronaPodsInfoDAL::$id_nier_rodzaj].', '.$tabParametr[StronaPodsInfoDAL::$id_trans_rodzaj].');';
            $wynik = $this->dal->PobierzDane($zapytanie, $ilosc_wierszy);
            UtilsDAL::KorektaKolBool($wynik, array(StronaPodsInfoDAL::$wylacznosc, StronaPodsInfoDAL::$klucz));
            UtilsDAL::TabPg2TabPhp($wynik, array(StronaPodsInfoDAL::$parametr_nazwa, StronaPodsInfoDAL::$parametr_wartosc, StronaPodsInfoDAL::$wyposazenie, StronaOfertaDAL::$zdjecie));
        ...
        public function IloscOfertRegion ($tabParametr)
        {
            $zapytanie = 'select IloscOfertRegion('.$tabParametr[StronaPodsInfoDAL::$id_nier_rodzaj].', '.$tabParametr[StronaPodsInfoDAL::$id_trans_rodzaj].', '.$tabParametr[StronaPodsInfoDAL::$id_region_geog].');';
            $wynik = $this->dal->PobierzDane($zapytanie, $ilosc_wierszy);
            //var_dump($wynik);
            return $wynik[0]['iloscofertregion'];
        }
        ...
        public function FiltracjaOfertaSkrocona ($tabParametr, &$ilosc_wierszy)
        {
            ...
            $zapytanie = 'select * from FiltracjaOfertWerPods('.$tabParametr[StronaPodsInfoDAL::$id_nier_rodzaj].', '.$tabParametr[StronaPodsInfoDAL::$id_trans_rodzaj].', 
        ...
        public function PodajZlecenia ($tabParametr, &$ilosc_wierszy)
        {
            $zapytanie = 'select * from PodstawowaWersjaZlecenia ('.$tabParametr[StronaPodsInfoDAL::$id_nier_rodzaj].', '.$tabParametr[StronaPodsInfoDAL::$id_trans_rodzaj].', '.$tabParametr[NieruchomoscDAL::$id_jezyk].');';
            $wynik = $this->dal->PobierzDane($zapytanie, $ilosc_wierszy);
            
             UtilsDAL::TabPg2TabPhp($wynik, array(StronaOfertaDAL::$lokalizacja));
    ...
    class StronaOfertaDAL
    {
        ...
        public function ZleceniaSubskrypcja()
        {
            $zapytanie = 'select * from ZleceniaSubskrypcja();';
            $wynik = $this->dal->PobierzDane($zapytanie, $ilosc_wierszy);
            UtilsDAL::TabPg2TabPhp($wynik, array(StronaPodsInfoDAL::$email, StronaPodsInfoDAL::$id_jezyk));
        ...
        public function OfertaZlecenieSubskrypcja($id_oferta)
        {
            $zapytanie = 'select * from OfertaZlecenieSubskrypcja('.$id_oferta.');';
            $wynik = $this->dal->PobierzDane($zapytanie, $ilosc_wierszy);
            //UtilsDAL::TabPg2TabPhp($wynik, array(StronaPodsInfoDAL::$email, StronaPodsInfoDAL::$id_jezyk));
            
            return $wynik;
        }
        public function OfertaZlecenieSms($id_oferta, &$ilosc_wierszy)
        {
            $zapytanie = 'select * from OfertaZlecenieSms('.$id_oferta.');';
            $wynik = $this->dal->PobierzDane($zapytanie, $ilosc_wierszy);
            
            return $wynik;
        }
        //weryfikacja dostarczenia sms
        public function StatusSms($tabParametr)
        {
            $telefon = UtilsDAL::TabPhp2TabPg($tabParametr[OsobaDAL::$telefon], false, $telefon);
            $id = UtilsDAL::TabPhp2TabPg($tabParametr[OsobaDAL::$id], false, $id);
            $punkty = UtilsDAL::TabPhp2TabPg($tabParametr[OsobaDAL::$punkty], false, $punkty);
            
            $zapytanie = 'select * from StatusSms('.$telefon.', '.$id.', '.$punkty.', '.$tabParametr[NieruchomoscDAL::$id_oferta].');';
            $wynik = $this->dal->OperacjaLogiczna($zapytanie);
    ...
    class StronaSubskrypcjaDAL
    {
        ...
        public function DodajSubskrypcjaZlecen($tabParametr, &$ilosc_wierszy)
        {
            $zapytanie = 'select * from DodajSubskrypcjaZl ('.$tabParametr[StronaSubskrypcjaDAL::$id_nier_rodzaj].', '.$tabParametr[StronaSubskrypcjaDAL::$id_trans_rodzaj].', '.
            $tabParametr[StronaSubskrypcjaDAL::$cena_max].', '.$tabParametr[StronaSubskrypcjaDAL::$powierzchnia].', \''.$tabParametr[StronaSubskrypcjaDAL::$email].'\', '.
            $tabParametr[StronaSubskrypcjaDAL::$id_jezyk].', '.$tabParametr[NieruchomoscDAL::$id_region_geog].');';
            $wynik = $this->dal->PobierzDane($zapytanie, $ilosc_wierszy);
            //echo $zapytanie;
            UtilsDAL::TabPg2TabPhp($wynik, array(StronaOfertaDAL::$lokalizacja));
        ...
        public function UsunSubskrypcjaZlecen($tabParametr)
        {
            $zapytanie = 'select * from UsunSubskrypcjaZl ('.$tabParametr[StronaSubskrypcjaDAL::$id_nier_rodzaj].', '.$tabParametr[StronaSubskrypcjaDAL::$id_trans_rodzaj].', \''.
            $tabParametr[StronaSubskrypcjaDAL::$email].'\');';
            $wynik = $this->dal->WprowadzanieDanych($zapytanie, false);
