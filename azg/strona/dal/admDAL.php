<?php
    ...
    class SzablonDAL
    {
        ...
        public static $id_transakcja = 'id_transakcja';
        ...
        public static $kwota = 'kwota';
        public static $referer = 'referer';
        public static $id_lista_wsk_adr = 'id_lista_wsk_adr';
        public static $id_strona_zakladki = 'id_strona_zakladki';
        public static $data_umowa_przed = 'data_umowa_przed';
        public static $termin_notar = 'termin_notar';
        public static $zdanie_nier = 'zdanie_nier';
        public static $plik_umowa = 'plik_umowa';
        public static $sprzedajacy = 'sprzedajacy';
        public static $kupujacy = 'kupujacy';
    }
    ...
    class TransakcjaDAL extends SzablonDAL
    {
        protected $dal;
       
        public function TransakcjaDAL()
        {
            $this->dal = new dal();
        }
        public function DodajTransakcja ($tabParametr)
        {
            $id_bank = 'null';
            if (isset($tabParametr[AdministracjaDAL::$id_bank]))
            {
                $id_bank = $tabParametr[AdministracjaDAL::$id_bank];
            }
            $zapytanie = 'select DodajTransakcja('.$tabParametr[AdministracjaDAL::$id_lista_wsk_adr].', \''.$tabParametr[AdministracjaDAL::$data_umowa_przed].'\', \''.$tabParametr[AdministracjaDAL::$cena].'\', 
            '.$id_bank.', \''.$tabParametr[AdministracjaDAL::$kwota].'\', \''.$tabParametr[AdministracjaDAL::$termin_notar].'\', \''.$tabParametr[AdministracjaDAL::$zdanie_nier].'\', 
            \''.$tabParametr[AdministracjaDAL::$plik_umowa].'\');';
            $wynik = $this->dal->OperacjaLogiczna($zapytanie);
            
            return $wynik;
        }
        /**
        * @desc sprawdza, czy nie wystepuje kolizja: dla ofert czy oferta nie jest w innej transakcji, dla zlecen czy edytowac istniejacy wpis o transakcji czy dodawac nowy ..
        */
        public function SprawdzCzyOfNieTransakcja ($tabParametr)
        {
            $zapytanie = 'select SprawdzCzyOfNieTransakcja('.$tabParametr[NieruchomoscDAL::$id_oferta].', '.$tabParametr[AdministracjaDAL::$id_lista_wsk_adr].');';
            $wynik = $this->dal->OperacjaLogiczna($zapytanie);
            
            return $wynik;
        }
        public function EdycjaTransakcja ($tabParametr)
        {
            $zapytanie = 'select * from PodajTransakcja('.$tabParametr[AdministracjaDAL::$id_lista_wsk_adr].');';
            $wynik = $this->dal->PobierzDane($zapytanie, $ilosc_wierszy);
            
            return $wynik[0];
        }
        public function FitracjaTransakcje ($tabParametr, &$ilosc_wierszy)
        {
            $sort_kol = '';
            ...
            $zapytanie = 'select * from FiltrTransakcje ('.$tabParametr[NieruchomoscDAL::$id_agent].', \''.$sort_kol.'\', '.$sort_kier.');';
            $wynik = $this->dal->PobierzDane($zapytanie, $ilosc_wierszy);
            
            return $wynik;
        }
        public function DodajNotatkaTransakcja ($tabParametr)
        {
            $zapytanie = 'select DodajNotatkaTransakcja ('.$tabParametr[AdministracjaDAL::$id_transakcja].', '.$tabParametr[AdministracjaDAL::$id_agent].', \''.$tabParametr[NieruchomoscDAL::$notatka].'\');';
            $wynik = $this->dal->OperacjaLogiczna($zapytanie);
            
            return $wynik;
        }
        public function PodajNotatkaTransakcja ($tabParametr, $ilosc_wierszy)
        {
            $zapytanie = 'select PodajNotatkaTransakcja ('.$tabParametr[AdministracjaDAL::$id_transakcja].');';
            $wynik = $this->dal->PobierzDane($zapytanie, $ilosc_wierszy);
    ...
    class AdministracjaDAL extends SzablonDAL
    {
        ...
        public function PodajZakladkiStr(&$ilosc_wierszy)
        {
            $zapytanie = 'select * from PodajZakladkiStr();';
            $wynik = $this->dal->PobierzDane($zapytanie, $ilosc_wierszy);
