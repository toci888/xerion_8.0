<?php
    ...
    class WyposazenieZapDAL
    {
        ...
        public function KojarzenieBazoweDlaZapotrzebowania($tabParametr = null, &$ilosc_wierszy)
        {
            ...
            UtilsDAL::KonwersjaDbBoolText($wynik, array(NieruchomoscDAL::$klucz));
    ...
    class ListaWskazanDAL
    {
        ...
        public static $oferent = 'oferent';
        public static $cena = 'cena';
        public static $cena_ogl = 'cena_ogl';
        public static $ulica = 'ulica';
    ...
    class OsobaDAL
    {
        ...
        public function PodajListaMailOsOtwZlec ($tabParametr, &$ilosc_wierszy)
        {
            $zapytanie = 'select * from PodajListaMailOsOtwZlec('.$tabParametr[NieruchomoscDAL::$id_zapotrzebowanie].');';
            $wynik = $this->dal->PobierzDane($zapytanie, $ilosc_wierszy);
            
            return $wynik;
        }
        public function OfertyZlecenieNaMail ($tabParametr, &$ilosc_wierszy)
        {
            $zapytanie = 'select * from OfertyZlecenieNaMail('.$tabParametr[NieruchomoscDAL::$id_zapotrzebowanie].');';
            $wynik = $this->dal->PobierzDane($zapytanie, $ilosc_wierszy);
        ...
        {
            $zapytanie = 'select * from PokazOdwiedziny('.$tabParametr[NieruchomoscDAL::$id_oferta].', \''.$tabParametr[NieruchomoscDAL::$data].'\', \''.$tabParametr[NieruchomoscDAL::$data_do].'\');';
            $wynik = $this->dal->PobierzDane($zapytanie, $ilosc_wierszy);
    ...
    class KlientDAL
    {
        ...
        public function PodajAgentSzablonUm($id_agent)
        {
            $zapytanie = 'select * from PodajAgentSzablonUm('.$id_agent.');';
            $wynik = $this->dal->PobierzDane($zapytanie, $IloscWierszy);
            
            return $wynik[0];
        }
        public function TransakcjeKlient ($tabParametr, &$ilosc_wierszy)
        {
            $zapytanie = 'select * from TransakcjeKlient ('.$tabParametr[NieruchomoscDAL::$id_klient].');';
            $wynik = $this->dal->PobierzDane($zapytanie, $ilosc_wierszy);
    ...
    class ExportDAL
    {
        ...
        public function PodajOfertaGratka ($id_oferta)
        {
            $zapytanie = 'select * from PodajOfertaGratka('.$id_oferta.');';
            $wynik = $this->dal->PobierzDane($zapytanie, $ilosc_wierszy);
            UtilsDAL::TabPg2TabPhp($wynik, array(ExportDAL::$zdjecie));
    ...
    class SlownikDAL 
    {
        ...
        public static function PobierzRegionGeog($id_parent)
        {
            ...
            $wynik = SlownikDAL::$dal->PobierzDane($zapytanie, $iloscWierszy);
            UtilsDAL::KorektaKolBool($wynik, array(SlownikDAL::$ma_dzieci));
