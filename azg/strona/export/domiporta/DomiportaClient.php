<?php
    ...
    class Domiporta extends ArchiwizacjaPortal
    {
        ...
        protected function Archiwizuj()
        {
            ...
            rename($this->nazwa_wys_plik, $this->sciezka_zapis.'/'.$this->nazwa_wys_plik);
