<div *ngIf="!showResultScreen else resultScreen">
    <div class="header">
    ...
    <div *ngIf="quiz.questions[questionNumber].type === 'single-choice'">
    ...
    <div *ngIf="quiz.questions[questionNumber].type === 'multiple-choice'">
    ...
    <div *ngIf="quiz.questions[questionNumber].type === 'multiple-select'">
