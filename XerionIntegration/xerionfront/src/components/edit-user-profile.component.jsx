            ...
            <mat-card-content [formGroupName]="i"> 
              ...
              <div>
                <mat-form-field>
                  ...
                  <mat-error
                    *ngIf="rangeExp.controls.datestart.hasError('matStartDateInvalid')">Invalid start date</mat-error>
                  <mat-error
                    *ngIf="rangeExp.controls.dateend.hasError('matEndDateInvalid')">Invalid end date</mat-error>
                </mat-form-field>
              </div>
            ...
            <mat-card-content [formGroupName]="i"> 
              ...
              <div>
                <mat-form-field>
                  ...
                  <mat-error *ngIf="rangeExp.controls.datestart.hasError('matStartDateInvalid')">Invalid start date
                  </mat-error>
                  <mat-error *ngIf="rangeExp.controls.dateend.hasError('matEndDateInvalid')">Invalid end date
                  </mat-error>
                </mat-form-field>
              </div>
            </mat-card-content>
          ...
          <div class="other-wraper">
            <ul class="other-block">
              <li *ngFor="let org of organizationsAndSkills.controls; let i = index">
                <p *ngIf="org.value.idaccountsoftskillstitle === 1" [formGroupName]="i">&#x2022;
                  <mat-form-field>
          ...
          <div class="other-wraper">
            <ul class="other-block">
              <li *ngFor="let skill of organizationsAndSkills.controls; let i = index">
                <p *ngIf="skill.value.idaccountsoftskillstitle === 2" [formGroupName]="i">&#x2022;
                  <mat-form-field>
          ...
          <div class="other-wraper">
            <ul class="other-block">
              <li *ngFor="let hobby of organizationsAndSkills.controls; let i = index">
                <p *ngIf="hobby.value.idaccountsoftskillstitle === 3" [formGroupName]="i">&#x2022;
                  <mat-form-field>
