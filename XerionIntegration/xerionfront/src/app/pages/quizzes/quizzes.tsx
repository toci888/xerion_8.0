<div class="quiz-main" { quiz && (>
    <div class="quiz-questions" { isQuizToBeStarted; else showThis && (>
        <!-- <div class="header"> -->
        <!-- <h3>Quiz: {{quiz.quiz.name}}</h3> -->
        <!-- </div> -->
        <questions [quizz]="quiz"></questions>
        <!--    <timer { isQuizToBeStarted && ( [totalTime]="quiz.quiz.totaltime"></timer>-->
    </div>
    <ng-template #showThis>
        ...
        <div class="background">
            <div class="wrapperUser">
                ...
                <div class="desc">
                    <a { quiz.quiz.description && ( class="description">{{quiz.quiz.description | capitalize}}</a>
                </div>
