...
<main class="page">
  <div class="wrapperUser">
    <div class="sections">
      <div class="upheader">
        <a { showEditButton && ( class="edit-button" matTooltip="{{'UserPage.Edit profile' | translate}}">
          ...
          <div class="companyName">
            ...
            <div class="icons">
              <ng-container *ngFor="let s of socials">
                <a { s.link.length > 0 && checkPlatforms(s.name) && ( href="https://www.{{s.link}}">
      ...
      <div class="technology" { technology.length > 0 && (>
        <p>Technologie:</p>
        <mat-grid-list cols="8" rowHeight="50px">
          ...
          <mat-grid-tile>
            <!-- <mat-icon class="add" svgIcon="addtool"></mat-icon> -->
          </mat-grid-tile>
        </mat-grid-list>
      </div>
      <div class="tools" { tools.length > 0 && (>
        <p>Narzędzia:</p>
        <mat-grid-list cols="8" rowHeight="50px">
      ...
      <div class="platforms" { platforms.length > 0 && (>
        <p>Platformy:</p>
        <mat-grid-list cols="8" rowHeight="50px">
      ...
      <div class="gallery" { images.length > 0 && (>
      ...
      <div class="map" { offices.length > 0 && (>
        <p>Nasze biura:</p>
      ...
      <div class="jobOffers">
        ...
        <div class="offer" *ngFor="let offer of offers">
          ...
          <div class="right">
            ...
            <div class="center">
              <button { showEditButton && offer.quizid! > 0 && ( mat-button class="applyButton" [routerLink]="'/joboffer/' + offer.id + '/applies'"><span>{{'NavigationMenu.View applies' | translate}}</span></button>
              <button { showEditButton && (offer.quizid == 0 || offer.quizid == null) && ( mat-button class="applyButton" [routerLink]="'/joboffer/' + offer.id + '/create-quiz'"><span>{{'NavigationMenu.Add quizz' | translate}}</span></button>
              <button { showEditButton && ( mat-button class="applyButton" (click)="deleteJobOffer(offer.id)"><span>{{'NavigationMenu.DeleteOffer' | translate}}</span></button>
            </div>
          </div>
        </div>
      </div>
