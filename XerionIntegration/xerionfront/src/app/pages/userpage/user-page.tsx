    ...
    <div class="sections">
      ...
      <div class="tags">
        <ng-container *ngFor="let tag of tags">
          <div class="tag" { tag.info.length >= 1 && (>
            #{{tag.info}}
          </div>
        </ng-container>
      </div>
      <div class="info">
        <mat-grid-list cols="3" rowHeight="50px">
          <div *ngFor="let info of informations">
            <mat-grid-tile { info.text !== null && info.text.length > 0 && (>
      ...
      <div class="skills" >
        <div class="sectionHeader" { getSkillCategories().values[0] && (>
        ...
        <div class="masonryHolder">
          <ul class="masonryBlocks" *ngFor="let skillCategory of getSkillCategories()">
            <li class="title" { skillCategory.value[0] && (>{{ skillCategory.key + ':' | capitalize }}</li>
            <ul>
        ...
        <div class="section" { experience && (>
          ...
          <ul class="sessions">
            <li *ngFor="let exp of experience">
              ...
              <!--              <p *ngFor="let expTasks of exp.tasks">&#x2022; {{expTasks}}</p>-->
            </li>
          </ul>
        </div>
      ...
      <div class="other">
        <div class="organizations" *ngFor="let other of other">
          ...
          <ng-container *ngFor="let duties of other.duties">
            <p { duties.length>0 && (>&#x2022; {{duties | capitalize}}</p>
          </ng-container>
        </div>
      </div>
    </div>
