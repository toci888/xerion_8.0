        ...
        <div class="sections">
            ...
            <form [formGroup]="quizForm" (ngSubmit)="submitQuiz()">
                <div class="head">
                    ...
                    <div { quizForm.get('quizName')?.hasError('required') && quizForm.get('quizName')?.touched && (
                         class="error-message">
                ...
                <div class="head">
                    ...
                    <div { quizForm.get('maxDuration')?.hasError('required') && quizForm.get('maxDuration')?.touched && (
                         class="error-message">
                ...
                <!--          <div { quizForm.get('maxPoints')?.hasError('required') && quizForm.get('maxPoints')?.touched && (-->
                <!--               class="error-message">-->
                ...
                <div class="head">
                    ...
                    <div { quizForm.get('passingThreshold')?.hasError('required') && quizForm.get('passingThreshold')?.touched && (
                         class="error-message">
                ...
                <div class="head">
                    ...
                    <div { quizForm.get('quizDescription')?.hasError('required') && quizForm.get('quizDescription')?.touched && (
                         class="error-message">
                ...
                <div class="head">
                    ...
                    <div { quizForm.get('quizTechnology')?.hasError('required') && quizForm.get('quizTechnology')?.touched && (
                         class="error-message">
                ...
                <div class="head">
                    ...
                    <div { quizForm.get('quizTechnologyType')?.hasError('required') && quizForm.get('quizTechnologyType')?.touched && (
                         class="error-message">
                    ...
                    <div *ngFor="let question of questionsArray.controls; let i=index">
                        <div [formGroupName]="i" class="question-container">
                            ...
                            <div class="head">
                                ...
                                <div
                                        { question.get('questionContent').hasError('required') && question.get('questionContent').touched && (
                                        class="error-message">
                                ...
                                <div class="answer"
                                    ...
                                    <div [formGroupName]="j">
                                        ...
                                        <div class="head">
                                            ...
                                            <div
                                                    { correctAnswer.get('correctAnswer').hasError('required') && correctAnswer.get('correctAnswer').touched && (
                                                    class="error-message">
                                        ...
                                        <div class="head">
                                            ...
                                            <div
                                                    { correctAnswer.get('correctAnswerScore').hasError('required') && correctAnswer.get('correctAnswerScore').touched && (
                                                    class="error-message">
                                ...
                                <div class="answer"
                                    ...
                                    <div [formGroupName]="k">
                                        ...
                                        <div class="head">
                                            ...
                                            <div
                                                    { falseAnswer.get('falseAnswer').hasError('required') && falseAnswer.get('falseAnswer').touched && (
                                                    class="error-message">
